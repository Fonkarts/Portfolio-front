...
import { faHeart, faInfoCircle, faCheck, faHandshake } from "@fortawesome/free-solid-svg-icons"; 
        ...
        <footer className="contact" id="contact"> {/*TRANSFORMER EN SECTION ET SEPARER FOOTER !*/}
            ...
            <div className="contact__mainContainer">
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    />
                    <div className={mailFocus && !validMail && mail ? "contact__mailNote--active" : "contact__mailNote"}>
                        <FontAwesomeIcon icon={faInfoCircle} />
                        <p id="mailnote">
                            Votre mail doit se présenter sous la forme 'user@mail.com'
                        </p>
                    </div>
                    ...
                    />
                    <div className={msgFocus && !validMsg && msg ? "contact__msgNote--active" : "contact__msgNote"}>
                        <FontAwesomeIcon icon={faInfoCircle} />
                        <p id="msgnote" >
                    ...
                    size={windowSize > 380 ? "normal" : "compact"}
                    ref={captchaRef}
                    />
                    </div>
            ...
            <div className="separator contact__separator"></div>
