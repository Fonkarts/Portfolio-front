        ...
        <section className="contact" id="contact"> 
            ...
            <div className="contact__mainContainer">
                ...
                <form onSubmit={handleSubmit}>
                          {/* GERER LES CAS D'ERREUR ET AFFICHER errMsg !*/}
            ...
            <div className="contact__socialItemContainer">
                ...
                <div className="contact__socialItem">
                    <p>
                        <a href="https://www.linkedin.com/in/sebastienhouchet-2473609a/" target="blank">
                ...
                <div className="contact__socialItem">
                    <p>
                        <a href="https://github.com/Fonkarts" target="blank">
